...
public class Utilidad extends GenericForwardComposer{
	...
	public static Object ejecutaConsulta(String query) throws SQLException {
		System.out.println("Consulta:" + query);
		Object[] params=null;
		Object temp = getQueryRunner().query(getConection(), query, getScalarHandler(),
				params);
		if (temp == null) {
			return "";
		}
	...
	public static List ejecutaConsultaList( String sql, BeanListHandler bean) throws SQLException {
		 Object[] params=null;
	...
	public static int ejecutaUpdate( String sql) throws SQLException {
		Object[] params=null;
		Connection enlace=getConection();
		int temp = getQueryRunner().update(enlace, sql, params);
		return temp;
